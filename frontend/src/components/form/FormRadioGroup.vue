...
<template>
  <fieldset>
    ...
    <p v-if="description" class="mt-1 text-sm/6 text-gray-600 dark:text-stone-400">
      {{ description }}
    </p>
    <div class="mt-6 space-y-6">
      ...
      >
        ...
        />
        <label :for="option.id" class="block text-sm/6 font-medium text-gray-900 dark:text-white">
          {{ option.label }}
        </label>
      </div>
    </div>
