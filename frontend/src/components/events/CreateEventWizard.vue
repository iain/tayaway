  ...
  >
    ...
    <div v-else-if="step === 2 && !dateMode">
      ...
      <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
        <button
          type="button"
          class="cursor-pointer rounded-lg border border-gray-200 p-4 text-left transition-colors hover:border-amber-300 hover:bg-amber-50 dark:border-stone-700 dark:hover:border-amber-700 dark:hover:bg-amber-900/10"
