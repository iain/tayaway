    ...
    <div class="space-y-4">
      <div>
        ...
        <input
          ...
          v-model="deadline"
          type="datetime-local"
          class="mt-2 block w-full rounded-md border-0 bg-white/5 px-3 py-1.5 text-gray-900 shadow-sm ring-1 ring-gray-300 ring-inset focus:ring-2 focus:ring-rose-500 focus:ring-inset sm:text-sm/6 dark:text-white dark:ring-gray-700"
        />
      </div>
    </div>
