      ...
      def call(task_list_id:, task_item_id:, membership:, content: nil, completed: nil, position: nil, new_task_list_id: nil)
        Auditable.around(
          ...
          Success()
            ...
            .bind { |(task_list, item, target)| validate_length(content, max: ValidationLimits::MEDIUM_TEXT, field: "Content").fmap { [task_list, item, target] } }
