        ...
        DB.transaction do
          ...
          if item_ids.any?
            ...
            item_ids.each do |item_id|
              Broadcaster.object_deleted("task_item", item_id, topics: [Topic.workspace(workspace_id)])
          ...
          Broadcaster.object_deleted("task_list", list_id, topics: [Topic.workspace(workspace_id)])
