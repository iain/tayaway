...
module Websocket
  ...
  #
  # Lives in a dedicated OS thread for the same reason as Websocket::Listener:
  # we want exactly one ping cycle per process, regardless of which Falcon
  # container model (forked/threaded/hybrid) is in use.
  #
