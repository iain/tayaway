...
class IO::Stream::Generic
  ...
  #
  # source://io-stream//lib/io/stream/generic.rb#31
  def initialize(**options); end

  # Best effort to flush any unwritten data, and then close the underling IO.
  #
  # source://io-stream//lib/io/stream/generic.rb#42
  def close; end
  ...
  # @return [Boolean]
  #
  # source://io-stream//lib/io/stream/generic.rb#37
  def closed?; end
  ...
  # @raise [NotImplementedError]
  #
  # source://io-stream//lib/io/stream/generic.rb#66
  def syswrite(buffer); end
...
module IO::Stream::Readable
  ...
  #
  # source://io-stream//lib/io/stream/readable.rb#57
  ...
  #
  # source://io-stream//lib/io/stream/readable.rb#74
  def block_size; end

  # Legacy setter for backwards compatibility
  #
  # source://io-stream//lib/io/stream/readable.rb#80
  def block_size=(value); end

  # Close the read end of the stream.
  #
  # source://io-stream//lib/io/stream/readable.rb#355
  def close_read; end

  # Efficiently discard data from the stream until encountering pattern.
  #
  # source://io-stream//lib/io/stream/readable.rb#228
  ...
  # @raise [EOFError]
  #
  # source://io-stream//lib/io/stream/readable.rb#335
  def eof!; end
  ...
  # @return [Boolean]
  #
  # source://io-stream//lib/io/stream/readable.rb#325
  def eof?; end
  ...
  # @raise [EOFError]
  #
  # source://io-stream//lib/io/stream/readable.rb#328
  def finish!; end
  ...
  # @return [Boolean]
  #
  # source://io-stream//lib/io/stream/readable.rb#315
  def finished?; end

  # Read a line from the stream, similar to IO#gets.
  #
  # source://io-stream//lib/io/stream/readable.rb#270
  ...
  #
  # source://io-stream//lib/io/stream/readable.rb#70
  ...
  #
  # source://io-stream//lib/io/stream/readable.rb#248
  def peek(size = T.unsafe(nil)); end

  # Read data from the stream.
  #
  # source://io-stream//lib/io/stream/readable.rb#88
  ...
  #
  # source://io-stream//lib/io/stream/readable.rb#131
  def read_partial(size = T.unsafe(nil), buffer = T.unsafe(nil)); end

  # Efficiently read data from the stream until encountering pattern.
  #
  # source://io-stream//lib/io/stream/readable.rb#211
  ...
  # @return [Boolean]
  #
  # source://io-stream//lib/io/stream/readable.rb#339
  def readable?; end

  # This is a compatibility shim for existing code that uses `readpartial`.
  #
  # source://io-stream//lib/io/stream/readable.rb#169
...
# source://io-stream//lib/io/stream/readable.rb#28
...
module IO::Stream::Writable
  ...
  #
  # source://io-stream//lib/io/stream/writable.rb#32
  ...
  #
  # source://io-stream//lib/io/stream/writable.rb#71
  def <<(string); end

  # Close the write end of the stream by flushing any remaining data.
  #
  # source://io-stream//lib/io/stream/writable.rb#93
  def close_write; end

  # Flushes buffered data to the stream.
  #
  # source://io-stream//lib/io/stream/writable.rb#43
  def flush; end

  # Returns the value of attribute minimum_write_size.
  #
  # source://io-stream//lib/io/stream/writable.rb#40
  ...
  #
  # source://io-stream//lib/io/stream/writable.rb#80
  def puts(*arguments, separator: T.unsafe(nil)); end

  # Writes `string` to the buffer. When the buffer is full or #sync is true the
  # buffer is flushed to the underlying `io`.
  #
  # source://io-stream//lib/io/stream/writable.rb#55
  def write(string, flush: T.unsafe(nil)); end

  private

  # source://io-stream//lib/io/stream/writable.rb#97
...
# source://io-stream//lib/io/stream/writable.rb#16
