...
module Async::HTTP::Protocol::HTTP2::Connection
  ...
  # source://async-http//lib/async/http/protocol/http2/connection.rb#109
  def peer; end

  # Returns the value of attribute promises.
  #
  # source://async-http//lib/async/http/protocol/http2/connection.rb#107
  def promises; end
  ...
  # @return [Boolean]
  #
  # source://async-http//lib/async/http/protocol/http2/connection.rb#124
  def reusable?; end
...
class Async::HTTP::Protocol::HTTP2::Request < ::Async::HTTP::Protocol::Request
  ...
  # source://async-http//lib/async/http/protocol/http2/request.rb#146
  def write_interim_response(status, headers = T.unsafe(nil)); end
end
...
class Async::HTTP::Protocol::HTTP2::Stream < ::Protocol::HTTP2::Stream
  ...
  #
  # source://async-http//lib/async/http/protocol/http2/stream.rb#157
  def closed(error); end

  # Called when the output terminates normally.
  #
  # source://async-http//lib/async/http/protocol/http2/stream.rb#126
  ...
  #
  # source://async-http//lib/async/http/protocol/http2/stream.rb#83
  def prepare_input(length); end

  # source://async-http//lib/async/http/protocol/http2/stream.rb#98
  ...
  #
  # source://async-http//lib/async/http/protocol/http2/stream.rb#119
  def send_body(body, trailer = T.unsafe(nil)); end

  # source://async-http//lib/async/http/protocol/http2/stream.rb#91
  def update_local_window(frame); end

  # source://async-http//lib/async/http/protocol/http2/stream.rb#77
  def wait_for_input; end

  # source://async-http//lib/async/http/protocol/http2/stream.rb#145
  def window_updated(size); end
end
...
# source://async-http//lib/async/http/server.rb#15
class Async::HTTP::Server < ::Protocol::HTTP::Middleware
  # @return [Server] a new instance of Server
  #
  # source://async-http//lib/async/http/server.rb#20
  def initialize(app, endpoint, protocol: T.unsafe(nil), scheme: T.unsafe(nil)); end

  # source://async-http//lib/async/http/server.rb#44
  def accept(peer, address, task: T.unsafe(nil)); end

  # source://async-http//lib/async/http/server.rb#28
  def as_json(*_arg0, **_arg1, &_arg2); end

  # Returns the value of attribute endpoint.
  #
  # source://async-http//lib/async/http/server.rb#40
  def endpoint; end
  ...
  # source://async-http//lib/async/http/server.rb#64
  def run; end
  ...
  # source://async-http//lib/async/http/server.rb#36
  def to_json(*_arg0, **_arg1, &_arg2); end
